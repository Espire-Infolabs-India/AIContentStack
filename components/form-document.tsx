...
export default function HomePage() {
    ...
    try {
      ...
      formDropdown?.forEach((dropdown) => {
        if (dropdown?.name && dropdown?.value) {
          Object.assign(data, {
            [dropdown?.name]: [
              { uid: dropdown?.value, _content_type_uid: dropdown?.id },
            ],
          });
        }
      });
  ...
  const renderResult = () => {
    ...
    return (
      <div className="genrate-content container">
  ...
  return (
    <>
      <header className="w-full header mb-4">
      ...
      {firstPage && (
        ...
        >
          <div className="bg-white border-[var(--border-color)] border-t-[1px] border-l-[1px] border-r-[1px] py-4 rounded-t-lg">
            ...
            <div className="flex justify-center flex-col md:flex-row py-2">
              <div className="drag-box md:w-1/2 text-right pr-6">
                Drag & drop or
              ...
              <div className="import-box md:w-1/2 flex flex-col justify-center md:justify-start md:pl-6">
                <label htmlFor="url" className="form-label flex justify-center md:justify-start">
                  Import from URL
                </label>
                <input
                  type="url"
